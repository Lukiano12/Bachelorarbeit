...
def octopart_price_nexar(article, nexar_token=NEXAR_TOKEN):
    url = "https://api.nexar.com/graphql"
    headers = {
        "Authorization": f"Bearer {nexar_token}",
    ...
    try:
        ...
        if price_data:
            ...
            price = price_data["price"] * 0.7  # 30% Rabatt!
            if usd_converted:
...
if __name__ == "__main__":
    print(octopart_price_nexar("STM32F103C8T6"))
